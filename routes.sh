...
# You must pass in the PEERING CONNECTION ID, INSTANCE ID, and REGION 
...
# REGION is where the databases are.
...
DB_SECURITY_GROUP=$(aws cloudformation list-exports --query "Exports[?Name=='$PREFIX-DBSecurityGroup'].Value" --output text)
