-- Original source: https://github.com/aws-samples/amazon-aurora-mysql-sample-hr-schema
-- Converted to postgresql format , but roughly equivalent to the above.
--
...
INSERT INTO jobs VALUES ( 'DATA_REP' , 'Human Resources Representative' , 4000 , 9000);
...
INSERT INTO employees VALUES ( 203 , 'Susan' , 'Mavris' , 'SMAVRIS' , '515.123.7777' , TO_DATE('07/06/2002', 'DD/MM/YYYY') , 'DATA_REP' , 6500 , NULL , 101 , 40);
